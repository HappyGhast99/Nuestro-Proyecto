...
- Express.js (v5.x): Framework web minimalista utilizado para construir la API RESTful de la aplicación, gestionar las rutas y servir los archivos estáticos.
...
## Herramientas de Desarrollo y Metodología
- Git & GitHub: Control de versiones y colaboración (trabajo con ramas, Pull Requests y resolución de conflictos de fusión).
